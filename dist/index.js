...
exports.remove_job = exports.pause_job = exports.resume_job = exports.restart_job = exports.job = exports.jobs = exports.remove_files = exports.print_file = exports.print = exports.printers = void 0;
...
const print = async (data, options) => {
    ...
    const optionsParams = {
        ...
        remove_after_print: typeof options.remove_temp != undefined
            ? options.remove_temp
            : true,
    };
 ...
 * @returns Success.
 */
const remove_files = async (paths) => {
    try {
        ...
        return {
            success: false,
            message: err.message ? err.message : "Fail to remove file",
        };
    }
};
...
const jobs = async (printerid = null) => {
    ...
    if (printerid != null) {
        ...
        if (printer.length == 0)
            return [];
        const result = await (0, tauri_1.invoke)("plugin:printer|get_jobs", {
...
const job = async (jobid) => {
    ...
    if (printername == null || id == null)
        null;
    const result = await (0, tauri_1.invoke)("plugin:printer|get_jobs_by_id", {
